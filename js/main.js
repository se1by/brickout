...
let baseWidth = (window.visualViewport !== undefined ? window.visualViewport.width : window.innerWidth);
let baseHeight = (window.visualViewport !== undefined ? window.visualViewport.height : window.innerHeight);

let maxWidth = baseWidth * 0.8;
let maxHeight = baseHeight * 0.8;

if (maxWidth / 800 > maxHeight / 600) {
    canvas.width = maxHeight * 4 / 3;
